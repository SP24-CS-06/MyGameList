...
const Review = (props: Props) => {
  ...
  return (
    <div className="w-full bg-[#ffffff] dark:bg-[#3b3b3b] rounded-[6px] p-4 flex flex-row shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      <div className="pr-3">
